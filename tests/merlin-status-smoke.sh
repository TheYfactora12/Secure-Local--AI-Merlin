...
require_output "$STATUS_OUTPUT" '^latest_route_id: search$' "latest route id missing"
require_output "$STATUS_OUTPUT" '^latest_staff_mode: operator$' "latest staff mode missing"
require_output "$STATUS_OUTPUT" '^latest_preferred_model_alias: mistral$' "latest preferred model missing"
require_output "$STATUS_OUTPUT" '^latest_selected_model_alias: mistral$' "latest selected model missing"
require_output "$STATUS_OUTPUT" '^latest_model_fallback_applied: false$' "latest fallback status missing"
require_output "$STATUS_OUTPUT" '^latest_audit_written: false$' "latest audit status missing"
