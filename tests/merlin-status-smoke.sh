...
require_output "$STATUS_OUTPUT" '^latest_preferred_model_alias: qwen7b$' "latest preferred model missing"
require_output "$STATUS_OUTPUT" '^latest_selected_model_alias: qwen7b$' "latest selected model missing"
